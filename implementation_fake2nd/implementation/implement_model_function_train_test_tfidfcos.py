...
import numpy as np
from feature_helpers.feature_generator \
    import make_tfidf_combined_feature_cos_5000_holdout, load_tfidf_y
...
def MLP_Classifier(row_body_train, row_stance_train, row_body_test, row_stance_test,
    ...
    n_classes = 4
    if mode == 'train':
        X_train = make_tfidf_combined_feature_cos_5000_holdout(row_body_train, row_stance_train, row_body_test, row_stance_test,
                                                               head_dir_train, body_dir_train, label_dir_train, cos_dir_train)
        y_train = load_tfidf_y(label_dir_train)
        n_input = X_train.shape[1]
    else:
        X_test = make_tfidf_combined_feature_cos_5000_holdout(row_body_test, row_stance_test, row_body_test, row_stance_test,
                                                              head_dir_test, body_dir_test, label_dir_test, cos_dir_test)
...
if __name__ == "__main__":
    ...
    head_dir_train = '../pickled_model/tfidf_head_feature_holdout_train.pkl'
    body_dir_train = '../pickled_model/tfidf_body_feature_holdout_train.pkl'
    label_dir_train = '../pickled_model/tfidf_label_one_hot_train.pkl'
    cos_dir_train = '../pickled_model/tfidf_cos_holdout_train.pkl'

    row_body_test = '../data/competition_test_bodies.csv'
    row_stance_test = '../data/competition_test_stances.csv'
    head_dir_test = '../pickled_model/tfidf_head_feature_holdout_test.pkl'
    body_dir_test = '../pickled_model/tfidf_body_feature_holdout_test.pkl'
    label_dir_test = '../pickled_model/tfidf_label_one_hot_test.pkl'
    cos_dir_test = '../pickled_model/tfidf_holdout_cos_test.pkl'

    save_model_path = '../tf_model/tfidf_5000_holdout_epoch'
