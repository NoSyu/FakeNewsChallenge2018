...
def MLP_Classifier(row_body_train, row_stance_train, row_body_test, row_stance_test,
                   ...
                   training_epoch=70,
                   init_bias=0.001, mode='train', save_model_path='../tf_model/tfidf_5000_epoch'):
    """
    ...
    n_classes = 4
    if mode == 'train':
        X_train = make_tfidf_combined_feature(row_body_train, row_stance_train, head_dir_train, body_dir_train, label_dir_train)
...
if __name__ == "__main__":
    ...
    MLP_Classifier(row_body_train, row_stance_train, row_body_test, row_stance_test,
                   ...
                   learning_rate=0.001, batch_size=188,
                   training_epoch=70,
                   init_bias=0.001, mode='test', save_model_path='../tf_model/tfidf_5000_epoch')
