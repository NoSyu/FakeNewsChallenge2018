...
EMBEDDINGS_DIR = "%s/embedding/" % (path.dirname(path.dirname(path.dirname(__file__))))
DATA_PATH = "%s/data/" % (path.dirname(path.dirname(path.dirname(__file__))))
SPLITS_DIR = "%s/splits/" % (path.dirname(path.dirname(path.dirname(__file__))))
