...
def main():
    ...
    gru_model = load_GRU_model(gru_model_path)
        ...
        try:
            ...
            if num == 1:
                try:
                    ...
                    feature = xgb.DMatrix(test_features_xgb.getrow(index), label=[test_y[index]])
                    ...
                    pred = xgb_pred * 0.7 + gru_pred * 0.3
                ...
                pred = np.argmax((xgb_pred * 0.7 + gru_pred * 0.3), axis=1)
